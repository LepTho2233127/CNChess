...
The core chess engine that handles game logic, move validation, and AI decision-making.
...
- **AI Decision Making** - Generating computer player moves
...
The core chess game logic and state management system.
